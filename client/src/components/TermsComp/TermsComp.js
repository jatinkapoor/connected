...
class TermsComp extends Component {
    ...
    <Typography>
     <Typography use="headline4">Privacy Policy</Typography>
        ...
        <p>
        This privacy notice discloses the privacy practices for this website (fill in URL)_. This privacy notice applies solely to information collected by this website and mailing list. It will notify you of the following:
        <br />
        <br />
        ...
        <br />
        <br />
        <Typography use="headline5">Security</Typography>
        <br />
        <br />
